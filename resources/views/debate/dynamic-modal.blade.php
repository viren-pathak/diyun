<div class="detail-drawer" id="detail-drawer">
    <div class="detail-drawer__header">
        <div class="detail-drawer__btnlist">
            <button type="button" id="comments-tab-btn">
            ...
            <button type="button" id="voters-tab-btn">
        ...
        <button type="button" class="close close-detail-drawer" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    <div class="detail-drawer__content">
        <div class="drawer__tab comments-drawer">
            @include('debate.comments')
        </div>

        <div class="drawer__tab duplicates-drawer">
            @include('debate.duplicates')
        </div>

        <div class="drawer__tab flags-drawer">
            @include('debate.flags')
        </div>

        <div class="drawer__tab locations-drawer">
            @include('debate.locations')
        </div>

        <div class="drawer__tab voters-drawer">
            <p>voters</p>
        </div>
    </div>
</div>
