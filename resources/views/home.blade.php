                ...
                <div class="col1 debate-col">
                    <ul class="card-grid four-card-grid">
                        @foreach($debateStats as $debate)
                            @php
                                $postNumber = ($loop->index + 1);
                                $class = ($postNumber % 7 == 5) ? 'horizantal-grid-card' : '';
                                $contriClass = ($postNumber % 7 == 5 && $debate->contributors->isNotEmpty()) ? (($postNumber - 5) / 7) % 2 == 0 ? 'right-contri-card' : 'left-contri-card' : '';
                            @endphp
                            <div class="debate-card {{ $class }} {{ $contriClass }} ">
                                        ...
                                        @if ($postNumber % 7 == 5 && $debate->contributors->isNotEmpty())
                                        <div class="debate-contributors-list">
                                            <h5 class="contributors-list-title">Contributors</h5>
                                            <ul class="contributors-list">
                                                @foreach($debate->contributors as $contributor)
                                                    <li class="contributor-item">
                                                        <img src="{{ $contributor['profile_picture'] }}" alt="{{ $contributor['username'] }}" class="avatar">
